...
<div class="min-h-[80vh] flex items-center justify-center px-4 py-12">
    <div class="max-w-md w-full bg-white dark:bg-slate-800 rounded-2xl shadow-xl p-6 md:p-8">
        <div class="text-center mb-6">
            ...
            <h1 class="text-2xl md:text-3xl font-bold text-slate-800 dark:text-white">Регистрация</h1>
            <p class="text-slate-500 dark:text-slate-400 text-sm mt-1">Создайте новый аккаунт</p>
        </div>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="mb-4">
                <label class="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-2">ФИО</label>
            ...
            <div class="mb-6">
                <label class="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-2">Подтверждение пароля</label>
